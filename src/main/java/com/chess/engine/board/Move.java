...
//    public static final Move NULL_MOVE = new NullMove();
    ...
    public static class MajorAttackMove extends AttackMove {
        ...
        @Override
        public String toString() {
            return movedPiece.getPieceType().toString() + BoardUtils.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate); // This doesn't seem correct? Attack move BE4? Should be an x somewhere similar to PawnAttackMove?
        }
    }
